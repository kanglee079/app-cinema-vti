...
class _MovieDetailRestApi implements MovieDetailRestApi {
  ...
  @override
  Future<MovieVideoReponse> getMovieVideos(int movieId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<MovieVideoReponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = MovieVideoReponse.fromJson(_result.data!);
    return value;
  }
